...
- **Cipher Listings** - a skill-based challenge instead of a bid: invited participants predict how a TEE will secretly reorder the creator's word list, and the closest match wins the item - not a raffle, the TEE only ever originates the answer at reveal time.

Also includes an Operations feed of real on-chain bid, reveal, and withdrawal activity.
